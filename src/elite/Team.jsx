        ...
        <div className="flex  justify-end lg:px-4 2xl:px-10">
          ...
          <div className="w-full">
            ...
            <div className="w-full flex flex-col justify-center items-center px-1 py-4">
              ...
              <p className="text-[#818491]  tracking-wide text-lg">MSc. Electrical Engineering</p>
              <p className="text-[#818491]  tracking-wide text-lg">PhD. Electrical Engineering</p>
              <p className="text-[#818491]  tracking-wide text-lg">( Cont. )
